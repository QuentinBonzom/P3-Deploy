...
// type TestResult = Result & { insertId?: number; affectedRows?: number };
...
//     const result = { insertId: 1 } as unknown as TestResult;
...
//     const result = { affectedRows: 1 } as unknown as Result;
...
//   it("should fail on invalid id", async () => {
//     // Mock result of the database query
//     const result = { affectedRows: 0 } as unknown as Result;
